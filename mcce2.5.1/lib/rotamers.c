        ...
        for (i_conf=0; i_conf<prot.res[i_res].n_conf; i_conf++) {
            ...
            for (i_atom=0; i_atom<prot.res[i_res].conf[i_conf].n_atom; i_atom++) {
                ...
                if (!strcmp(orbital, "sp3")) {
                    ...
                    //        continue;
                            back_atom = *known_atoms[0]->connect12[1];
                            v.x =  1.0; v.y =  1.0; v.z =  1.0; back_atom.xyz = vector_vplusv(back_atom.xyz, v);
                            back_atom_p = &back_atom;
                        }
